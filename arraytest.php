        ...
        <?php include("includes/menu.php"); ?>
            ...
            <div class="container">
                <div class="row">
                    ...
                    Array fed search Results (refresh the page to get new search links)
                    <?php
...
?>
                        <BR>
                        <BR>
                        <a href="http://www.swagbucks.com/?t=w&p=1&q=<?php echo $firstArray[$rand_keys1] ?>+<?php echo $secondArray[$rand_keys2] ?>" class="menuLink" target="_blank">Click Here for SB</a>
                        <BR>
                        <a href="http://search.pch.com/search?q=<?php echo $firstArray[$rand_keys1] ?>+<?php echo $secondArray[$rand_keys2] ?>" class="menuLink" target="_blank">Click here for PCH</a>
